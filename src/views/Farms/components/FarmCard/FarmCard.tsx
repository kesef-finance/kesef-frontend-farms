...
const FarmCard: React.FC<FarmCardProps> = ({ farm, removed, cakePrice, cakeLpPrice, adaPrice, bnbPrice, ethereum, account }) => {
  ...
  const totalValue: BigNumber = useMemo(() => {
    ...
    if (farm.quoteTokenSymbol === QuoteToken.KSF) {
      return cakePrice.times(farm.lpTotalInQuoteToken)
    }
     if (farm.quoteTokenSymbol === QuoteToken.CAKELP) {
      return cakeLpPrice.times(farm.lpTotalInQuoteToken)
    }
    return farm.lpTotalInQuoteToken
  }, [bnbPrice, cakePrice, cakeLpPrice ,farm.lpTotalInQuoteToken, farm.quoteTokenSymbol])
  ...
  return (
    <FCard>
      {farm.tokenSymbol === 'KSF' && <StyledCardAccent />}
      <CardHeading
        lpLabel={lpLabel}
